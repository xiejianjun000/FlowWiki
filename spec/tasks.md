...
| 5.2 | 写通用 7 场景的 README | 00_首页/03_实战场景/*/README.md | ✅ 补齐（7 场景全齐） |
| 5.3 | 抽取合规审查最佳实践 → 案卷评查场景 | 00_首页/03_实战场景/案卷评查/README.md | ✅ 补齐 |
| 5.4 | 抽取证照管理最佳实践 → 证照管理场景 | 00_首页/03_实战场景/证照管理/README.md | ✅ |
| 5.5 | 抽取企业合规库最佳实践 → 合规场景 | 00_首页/03_实战场景/企业合规/README.md | ✅ |
| 5.6 | 抽取根因分析最佳实践 → 根因分析场景 | 00_首页/03_实战场景/根因分析/README.md | ✅ |
| 5.7 | 补齐现场核查/合规审查/审计准备场景 | 00_首页/03_实战场景/*/README.md | ✅ 补齐（3 个场景） |
...
**验收**：通用 7 场景参考实现 + 可拔插验证通过。✅（场景+skill+yaml 齐备，端到端测试待补）
...
| 3 个场景缺失 | 创建现场核查、案卷评查、审计准备场景 README + industry.yaml |
