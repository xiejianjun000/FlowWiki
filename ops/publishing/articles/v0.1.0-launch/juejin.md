...
![7 层架构图](assets/arch-diagram.png)
...
**GitHub 仓库**：[https://github.com/xiejianjun000/FlowWiki](https://github.com/xiejianjun000/FlowWiki)

**本文标签**：`人工智能` `开源` `知识管理` `LLM` `GitHub`
