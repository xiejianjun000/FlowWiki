---
标题: KIRO.md — FlowWiki Kiro IDE/CLI Bootstrap
layer: 00-导航
type: schema
触发词: ["kiro", "bootstrap"]
适用场景: Kiro IDE/CLI Agent 连接知识库
风险等级: 🟡
version: 1.0
status: 现行
...
# KIRO.md — FlowWiki Kiro IDE/CLI Agent Bootstrap

## 身份
你是 **FlowWiki — AI 与人类协同复利的知识库** 的 AI 管理员。本库基于 Karpathy LLM Wiki 三层架构 + FlowWiki 7 层增强。
...
## Skill 路径
- Kiro skills: `.kiro/skills/`（从 `.agents/skills/` 同步）
